## Repeat Profiling Workflow

This subdirectory  includes a Nexflow workflow to process and summarize repeats in input nucleotide FASTA files. To use the workflow, you will need to have Docker and Nextflow installed:
...
cd REprofile/repeat_profiler_workflow #move into repository and workflow folders
```
